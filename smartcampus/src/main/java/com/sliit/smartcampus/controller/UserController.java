...
public class UserController {
    ...
    public ResponseEntity<?> loginUser(@RequestBody LoginRequest loginRequest, HttpServletRequest request) {
        ...
        try {
            ...
            if (user != null) {
                // Check if user is Admin - trigger MFA (Excluding default admin for easy testing)
                if ("ADMIN".equalsIgnoreCase(user.getRole()) && !"admin@smartcampus.com".equals(user.getEmail())) {
